        ...
        <div className="container mx-auto py-2 px-6 md:px-4">
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-sm text-[#ababab]">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione itaque sapiente, inventore, culpa quisquam id illo accusamus natus voluptatibus nemo repellendus delectus quasi, quaerat aperiam aut quae quis? Atque, quo.</p>
                </div>
