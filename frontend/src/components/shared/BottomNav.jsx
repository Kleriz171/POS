...
const BottomNav = () => {
    ...
    return (
        <div className='fixed bottom-0 left-0 right-0 bg-[#262626] p-2 h-16 flex justify-around z-50'>
            <button
                onClick={() => navigate("/")}
                className='text-[#ababab] bg-[#343434] cursor-pointer w-50 rounded-[20px]'>
                <Home className='inline mr-4' size={30} /> Home
            </button>

            <button
                onClick={() => navigate("/orders")}
                className='text-[#ababab] cursor-pointer bg-[#343434] w-50 rounded-[20px]'>
            ...
            <button
                onClick={openModal}
                className='bg-[#f6b100] p-2 w-15 h-15 cursor-pointer rounded-full text-white absolute justify-center items-center bottom-3.5'>
